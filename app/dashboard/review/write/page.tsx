...
function habitNeedsAttention(h: SummaryHabit): boolean {
    ...
    <div className="space-y-6">
      ...
      {summary && summary.habits.length > 0 && (
        <div className="grid grid-cols-1 gap-6 lg:grid-cols-[1fr_340px]">
          {/* Left column: habit cards + weekly reflection */}
          <div className="space-y-6">
            {/* Habit scoreboard cards */}
            <div>
          ...
          {/* Right column: Wins & Needs attention + Atomic Habits insight */}
